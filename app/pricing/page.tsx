...
const PLANS = [
  {
    ...
    icon: Zap,
    features: [
      { text: '50 leads/mois', included: true },
      { text: 'Lead Detection & Scoring IA', included: true },
      { text: 'Content AI (analyse texte)', included: true },
      { text: 'Dashboard Analytics', included: true },
      { text: 'Support email', included: true },
      { text: 'Auto-DM', included: false },
      { text: 'Video Analyzer', included: false },
      { text: 'Competitor Spy', included: false },
      { text: 'Smart Calendar', included: false },
    ],
    popular: false,
  },
  {
    ...
    icon: Sparkles,
    features: [
      { text: '200 leads/mois', included: true },
      { text: 'Tout du plan Starter', included: true },
      { text: 'Auto-DM illimité', included: true },
      { text: 'Video Analyzer (10/mois)', included: true },
      { text: 'Templates DM personnalisés', included: true },
  ...
  },
  {
    ...
    description: 'Pour dominer le marché',
    icon: Crown,
    features: [
      { text: 'Leads illimités', included: true },
      { text: 'Tout du plan Pro', included: true },
      { text: 'Video Analyzer illimité', included: true },
      { text: '🔒 Competitor Spy', included: true },
      { text: '🔒 Smart Calendar', included: true },
      { text: 'API Access', included: true },
      { text: 'White-label reports', included: true },
      { text: 'Support 24/7 + Coach dédié', included: true },
